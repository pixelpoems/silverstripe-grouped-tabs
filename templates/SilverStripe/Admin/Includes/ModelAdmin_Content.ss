	...
	<div class="cms-content-header north">
		...
		<div class="cms-content-header-tabs cms-tabset-nav-primary ss-ui-tabs-nav">
			<ul class="cms-tabset-nav-primary">
				...
				<% if $IsGroup %>
				<li class="tab-group $LinkOrCurrent<% if $LinkOrCurrent == 'current' %> ui-tabs-active<% end_if %>">
					<a href="$FirstLink" class="cms-panel-link tab-group-title">$Title</a>
					<div class="tab-group-items">
						<% loop $Items %>
						<div class="tab-group-item $LinkOrCurrent<% if $LinkOrCurrent == 'current' %> ui-tabs-active<% end_if %>">
